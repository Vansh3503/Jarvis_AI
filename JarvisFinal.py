...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        customfont = QtGui.QFont("AvengeanceHeroicAvengerNormal-Bz7d.ttf")
        
        customfont.setPointSize(10)
        self.textEdit.setFont(customfont)
        ...
        customfont.setPointSize(10)
        self.entecomm.setFont(customfont)
        self.entecomm.setStyleSheet("color:white;")
...
"background-color:transparent;")
        ...
        self.label_3.raise_()  # Bring label_3 to the front
...
"background-color:transparent;")
        ...
        self.P3.setText("")
        self.P3.setPixmap(QtGui.QPixmap("initial.gif"))
        self.P3.setScaledContents(True)
        self.P3.setObjectName("P3")
        self.sleeping = QtWidgets.QLabel(Form)
        self.sleeping.setGeometry(QtCore.QRect(40, 190, 351, 211))
        self.sleeping.setStyleSheet("border:1px solid white;")
        self.sleeping.setText("")
        self.sleeping.setPixmap(QtGui.QPixmap("__1.gif"))
        self.sleeping.setScaledContents(True)
        self.sleeping.setObjectName("P2")
        self.frame.raise_()
        self.speak = QtWidgets.QLabel(Form)
        self.speak.setGeometry(QtCore.QRect(40, 190, 351, 211))
        self.speak.setStyleSheet("\n"
"border-image: url(ggg.gif);")
        self.speak.setText("")
